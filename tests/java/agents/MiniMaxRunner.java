...
public class MiniMaxRunner {
    ...
    private void makeMove(String board) {
        ...
        Move bestMove = miniMax.bestMove(boardState, searchDepth);
    ...
    public static void main(String[] args) {
        ...
        String stringSearchDepth = args[4];
        int player = Integer.parseInt(stringPlayer);
        int size1 = Integer.parseInt(stringSize1);
        int size2 = Integer.parseInt(stringSize2);
        int searchDepth = Integer.parseInt(stringSearchDepth);
        MiniMaxRunner agent = new MiniMaxRunner(
            gameName,
            player,
            size1,
            size2,
